...
| gpt-oss-120b | `--kv_cache_dtype fp8 --gpu-memory-utilization 0.3` + `ATOM_GPT_OSS_MODEL=1` | 0.38 | Yes | mi355-1 |
| gpt-oss-120b (2 GPU) | `-tp 2 --enable-dp-attention --enable-expert-parallel` + `ATOM_GPT_OSS_MODEL=1` | 0.38 | No | mi355-4 |
