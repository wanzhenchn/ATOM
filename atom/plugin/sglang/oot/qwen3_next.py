...
Registers Qwen3NextForCausalLM via SGLANG_EXTERNAL_MODEL_PACKAGE, 
delegating to ATOM implementations in atom.models.qwen3_next.
"""
...
class Qwen3NextForCausalLM(nn.Module):
    """ATOM-backed Qwen3Next for SGLang."""
