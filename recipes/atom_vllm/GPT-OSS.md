...
This recipe shows how to run `GPT-OSS-120B` with the ATOM vLLM out-of-tree platform. For background on the OOT backend, see [ATOM vLLM Plugin Backend](../../docs/vllm_plugin_backend_guide.md).
